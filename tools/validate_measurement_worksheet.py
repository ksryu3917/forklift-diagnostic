...
if 'versionCode 34' not in gradle: errors.append('versionCode 34 missing')
if 'versionName "0.18-rc-expert-v8.9-adaptive-branch"' not in gradle: errors.append('V8.9 versionName missing')
rel=json.loads((ROOT/'app/src/main/assets/diagnostic_release.json').read_text(encoding='utf-8'))
if rel.get('state')!='RC EXPERT V8.9 ADAPTIVE BRANCH': errors.append('release state mismatch')
if rel.get('version_name')!='0.18-rc-expert-v8.9-adaptive-branch': errors.append('release version mismatch')
